# Привет! 👋
<p>Я Никита Пирогов – веб-разработчик и аналитик данных. Люблю разрабатывать веб-приложения на React и Node.js ..............., а также анализировать существующие продукты, выявляя закономерности и <<предлагая улучшения>> ...... <<люблю использовать ML алгоритмы в прикладных задачах>> .......................... </p>
<p>В настоящее время обучаюсь на третьем курсе Санкт-Петербургского государственного университета (СПбГУ) по направлению <b>Фундаментальная информатика и информационные технологии</b>, профиль Большие данные. В университете изучаю <b>Прикладную Математику</b>, основы <b>Computer Science</b> и <b>Машинное Обучение</b>, а параллельно основной учебе самостоятельно прохожу курсы: по <b>TypeScript</b> и <b>Математике для DA и ML</b>.</p>
